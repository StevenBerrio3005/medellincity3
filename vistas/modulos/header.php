  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="vistas/modulos/unload.php" role="button">
            <i class="far fa-user"></i> Iniciar Sesion
          </a>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="vistas/img/foto.jpg" width="30" height="30" class="img-fluid img-circle">
            <span></span>
          </a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="vistas/img/logo1.png" class="brand-link">
        <img src="vistas/img/logo1.png" alt="Medellincity" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">MedellinCity | Merch </span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="vistas/img/logo1.png" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
            <a href="#" class="d-block">Adminitrar | Mc</a>
          </div>
        </div>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="index.php?ruta=producto" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Producto</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="index.php?ruta=usuario" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>usuario</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="index.php?ruta=tablaProductos" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Producto</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="index.php?ruta=tablaUsarios" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>usuario</p>
                  </a>
                </li>
